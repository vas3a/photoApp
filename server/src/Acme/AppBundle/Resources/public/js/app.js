...
}, "spine/lib/list": function(exports, require, module) {// Generated by CoffeeScript 1.3.3
(function() {
  var $, Spine,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
  ...
  Spine.List = (function(_super) {
    ...
    List.prototype.activatePrev = function() {
      $(this.children().get(this.items.indexOf(this.current))).prev().click();
    };

    List.prototype.activateNext = function() {
      $(this.children().get(this.items.indexOf(this.current))).next().click();
    };
    ...
    List.prototype.render = function(items) {
      ...
      this.current = this.current ? this.items[this.current.id-1] : undefined;
...
(function() {
...
}, "views/thumbnail": function(exports, require, module) {module.exports = function(values, data){ 
  var $  = jQuery, result = $();
  ...
  (function() {
    (function() {
      ...
      __out.push('<span class="item thumbnail">\n\t<span class="image-name">');
    
      __out.push(__sanitize(this.title));
    
      __out.push('</span>\n\t<img src="');
    
      __out.push(__sanitize(this.thumbsrc));
  ...
  (function() {
    (function() {
      ...
      __out.push('<div class="layout">\n\t<div class="views">Views: <span class="counter"></span></div>\n</div>');
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/view": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      ...
      __out.push('<div class="image" style="position: relative">\n\t<img class="bigImage" src="');
      ...
      __out.push(__sanitize(this.elId));
  ...
  var App, Image, Spine, ThumbController, ViewController,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  App = (function(_super) {
    ...
    function App() {
      this._onKeyPressed = __bind(this._onKeyPressed, this);

      this._onThumbActivate = __bind(this._onThumbActivate, this);
      App.__super__.constructor.apply(this, arguments);
      this.thumb = new ThumbController;
      this.view = new ViewController;
      this.append(this.view, this.thumb);
    }

    App.prototype._onThumbActivate = function(ev, slug) {
      return this.view.show({
        slug: slug
      });
    };

    App.prototype._onKeyPressed = function(ev) {
      if (ev.which === 39) {
        return this.thumb.trigger('show_next');
      } else if (ev.which === 37) {
        return this.thumb.trigger('show_prev');
      }
    };
...
}, "controllers/thumbnail": function(exports, require, module) {(function() {
  var Image, Preloader, Spine, Thumbnail,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Thumbnail = (function(_super) {

    __extends(Thumbnail, _super);

    Thumbnail.prototype.className = 'thumbsContainer';

    Thumbnail.prototype.elements = {
    ...
    Thumbnail.prototype.preloader = new Preloader();

    Thumbnail.prototype.trace = false;

    function Thumbnail() {
      this.centrate = __bind(this.centrate, this);
      ...
      this._showPrev = __bind(this._showPrev, this);
      Thumbnail.__super__.constructor.apply(this, arguments);
      this.append('<div class="thumbList"></div>', this.preloader);
      this.thumbList = new Spine.List({
        el: this.thumbListDiv,
        template: require('views/thumbnail'),
        selectFirst: true
      });
      this.thumbList.bind('change', this.change);
      Image.bind('refresh change', this.render);
      this.bind('show_next', this._showNext);
      this.bind('show_prev', this._showPrev);
    }

    Thumbnail.prototype._showPrev = function() {
      return this.thumbList.activatePrev();
    };

    Thumbnail.prototype._showNext = function() {
      return this.thumbList.activateNext();
    };

    Thumbnail.prototype.render = function() {
      this.preloader.startPreload();
      this.thumbListDiv.css({
        'width': Image.count() * 90
      });
      return this.thumbList.render(Image.all());
    };

    Thumbnail.prototype.change = function(img) {
      this.el.parents().trigger('thumb_activated', img.slug);
      return this.centrate(img);
    };

    Thumbnail.prototype.centrate = function(img) {
      var mL, mR, newLeft, thumb, thumbMarginLeft, thumbMarginRight, totalWidth, w, windowWidth;
      ...
      if ((thumbMarginLeft > mL || thumbMarginRight > mR) && (newLeft <= 0 && (totalWidth + newLeft) > windowWidth)) {
        this.el.css({
          left: newLeft
        });
      }
      this.log('thumbMarginLeft', thumbMarginLeft, 'thumbMarginRight', thumbMarginRight, 'mL', mL, 'mR', mR);
      this.log('totalWidth', totalWidth, 'totalWidth-newLeft', totalWidth - newLeft, 'windowWidth', windowWidth);
      return this.preloader.load(thumb.index());
    };
...
}, "controllers/view": function(exports, require, module) {(function() {
  var Image, Spine, View,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  View = (function(_super) {
    ...
    View.prototype.className = 'viewport';

    View.prototype.template = 'views/view';
    ...
    View.prototype.easing = 'swing';

    View.prototype.item = null;

    function View() {
      this.updateLayout = __bind(this.updateLayout, this);

      this.anime = __bind(this.anime, this);

      this.anime_prev = __bind(this.anime_prev, this);

      this.anime_next = __bind(this.anime_next, this);

      this.render = __bind(this.render, this);

      this.show = __bind(this.show, this);
      View.__super__.constructor.apply(this, arguments);
      this.append(require('views/layout'));
      this.animeDurationTime = 200;
      this.item = this.img = Image.first();
      this.render;
    }

    View.prototype.show = function(params) {
      this.img = Image.filter(params.slug);
      return this.render();
    };
    ...
    View.prototype.render = function() {
      var dir;
      if (this.item) {
        if (parseInt(this.item.id) < parseInt(this.img[0].id)) {
          dir = 'next';
        } else {
          dir = 'prev';
        }
      ...
      this.item = this.img[0];
      this.append(require(this.template)(this.item));
      this['anime_' + dir]();
      this.log('anime_' + dir);
      this.item.views++;
    ...
    View.prototype.anime_next = function() {
      return this.anime(-600);
    };

    View.prototype.anime_prev = function() {
      return this.anime(600);
    };

    View.prototype.anime = function(to) {
      var _this = this;
      $(this.image[1]).css({
        left: -to
      });
      if (this.image[1]) {
        $(this.image[0]).stop(true, true).animate({
          left: to
        }, {
          duration: this.animeDurationTime,
          easing: this.easing,
          complete: function() {
            $(_this.imageDiv[0]).remove();
            return _this.updateLayout(_this.item);
          }
        });
        return $(this.image[1]).stop(true, true).animate({
          left: 0
        }, {
          duration: this.animeDurationTime,
          easing: this.easing
        ...
        return this.updateLayout(this.item);
      }
    };

    View.prototype.updateLayout = function(item) {
      return this.viewsCounter.text(item.views);
    };
...
}, "controllers/preloader": function(exports, require, module) {(function() {
  var Image, Preloader, Spine,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Preloader = (function(_super) {
    ...
    Preloader.prototype.className = 'preloader';

    Preloader.prototype.offset = 0;

    Preloader.prototype.limit = 15;

    Preloader.prototype.trace = false;
    ...
    function Preloader() {
      ...
      this.startPreload = __bind(this.startPreload, this);

      this.loadNext = __bind(this.loadNext, this);

      this.load = __bind(this.load, this);
      Preloader.__super__.constructor.apply(this, arguments);
    }
    ...
    Preloader.prototype.loadNext = function(index) {
      var l;
      this.log(index);
      this.log(this.max - this.limit / 2);
      l = this.max - Math.round(this.limit / 2) - 1;
      if (index >= l) {
        Image.fetch();
        this.max = Image.count();
      }
      return this.loadMore(index, Math.round(this.limit / 2));
    };
    ...
    Preloader.prototype.loadMore = function(offset, limit) {
      var imagesToPreload, img, _i, _len, _results;
      imagesToPreload = Image.all().splice(offset, limit);
      _results = [];
      for (_i = 0, _len = imagesToPreload.length; _i < _len; _i++) {
        img = imagesToPreload[_i];
        _results.push(this.loadImage(img));
      }
      return _results;
    };

    Preloader.prototype.loadImage = function(img) {
      var t,
        _this = this;
      img.elId = 'image-c-id-' + img.id;
      this.el.append(require('views/view')(img));
      return t = setTimeout(function() {
        clearTimeout(t);
        return $('#' + img.elId).parent().remove();
      }, 500);
    };
  ...
  Image = (function(_super) {
    ...
    Image.configure('Image', 'title', 'slug', 'imgsrc', 'thumbsrc', 'views', 'index');

    Image.extend(Spine.Model.Ajax);

    Image.filter = function(query) {
      if (!query) {
        return this.all();
      }
      ...
      return this.select(function(item) {
        var _ref, _ref1;
        return ((_ref = item.title) != null ? _ref.toLowerCase().indexOf(query) : void 0) !== -1 || ((_ref1 = item.slug) != null ? _ref1.toLowerCase().indexOf(query) : void 0) !== -1;
      });
    };

    Image.fetch = function(params) {
      var index, _ref;
