...
(function() {
  ...
  (function() {
    (function() {
      ...
      __out.push('<img class="bigImage" src="');
  ...
  App = (function(_super) {
    ...
    App.prototype._onKeyPressed = function(ev) {
      if (ev.which === 39) {
        return this.thumb.trigger('show_next', 'sf');
      } else if (ev.which === 37) {
        return this.thumb.trigger('show_prev', 'ssffe');
      }
    };
  ...
  Thumbnail = (function(_super) {
    ...
    function Thumbnail() {
      ...
      this.append('<div class="thumbs"></div>');
      this.thumbs = new Spine.List({
        el: this.thumbsDiv,
        template: require('views/thumbnail'),
        selectFirst: true
      });
      this.thumbs.bind('change', this.change);
    ...
    Thumbnail.prototype._showPrev = function() {
      return this.thumbs.activatePrev();
    };

    Thumbnail.prototype._showNext = function() {
      return this.thumbs.activateNext();
    };

    Thumbnail.prototype.render = function() {
      return this.thumbs.render(Image.all());
    };

    Thumbnail.prototype.change = function(img) {
      return this.el.parents().trigger('thumb_activated', img.slug);
    };
  ...
  View = (function(_super) {
    ...
    View.prototype.render = function() {
      var dir;
      if (this.item) {
        if (this.getInt(this.item.cid) < this.getInt(this.img[0].cid)) {
          dir = 'next';
        } else {
          dir = 'prev';
        }
      ...
      this.append(require(this.template)(this.img[0]));
      this.item = this.img[0];
      return this['anime_' + dir]();
    };
    ...
    View.prototype.getInt = function(cid) {
      return parseInt(cid.split('-')[1]);
    };
  ...
  Image = (function(_super) {
    ...
    Image.configure('Image', 'name', 'slug', 'img_url', 'thumb_url');

    Image.extend(Spine.Model.Ajax);

    Image.prototype.url = "/photos";
    ...
    Image.filter = function(query) {
      ...
      return this.select(function(item) {
        var _ref, _ref1;
        return ((_ref = item.name) != null ? _ref.toLowerCase().indexOf(query) : void 0) !== -1 || ((_ref1 = item.slug) != null ? _ref1.toLowerCase().indexOf(query) : void 0) !== -1;
      });
    };
